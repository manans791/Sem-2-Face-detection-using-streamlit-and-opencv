...
def main():
    ...
    st.title("Face Detection App with addittional features")
    st.text("Build with Streamlit and OpenCV by Manan Sharma")
    ...
    if choice == 'Detection':
        ...
        st.markdown("Built with Streamlit by Manan Sharma")

        st.success("Sem 2 Project")
